...
export const PARTNERS: Partner[] = [
  // Devices & Tools
  {
    ...
    category: ["devices"],
    description:
      "Get smartphones, laptops, and electronics on flexible payment plans. Pay in installments over 3-12 months.",
  ...
  },
  {
    ...
    category: ["devices"],
    description:
      "Nigeria's leading device financing platform. Buy now, pay later for gadgets and appliances.",
  ...
  },
  {
    ...
    category: ["devices"],
    description:
      "Finance phones and laptops with flexible repayment. Zero interest on select items.",
  ...
  },
  {
    ...
    description:
      "Pay-as-you-go financing for solar systems and smartphones. Africa's largest connected asset platform.",
  ...
  },
  {
    ...
    category: ["devices"],
    description:
      "Buy now, pay later across partner merchants. Flexible installment payments (subject to approval).",
  ...
  },
  {
    ...
    category: ["devices"],
    description:
      "Installment payments for gadgets and essentials through partner merchants (subject to eligibility).",
  ...
  // Solar & Power
  {
    ...
    category: ["solar"],
    description:
      "Solar home systems with affordable payment plans. Light up your home with pay-as-you-go solar.",
  ...
  },
  {
    ...
    category: ["solar"],
    description:
      "Solar home systems with pay-as-you-go style repayment (availability varies by location).",
  ...
  },
  {
    ...
    category: ["solar"],
    description:
      "Premium solar solutions for homes and businesses. Reliable power with smart financing.",
  ...
  },
  {
    ...
    category: ["solar"],
    description:
      "Affordable solar power for Nigerian homes. Spread your payment over 12-24 months.",
  ...
  },
  {
    ...
    category: ["solar"],
    description:
      "Solar and inverter solutions for homes and small businesses. Financing may be available via partner plans.",
  ...
  // Rent & Housing
  {
    ...
    category: ["rent"],
    description:
      "Pay rent monthly instead of yearly. Find verified properties and flexible housing.",
  ...
  },
  {
    ...
    category: ["rent"],
    description:
      "Rent now, pay later. Spread your rent payment over 12 months with low interest.",
  ...
  },
  {
    ...
    category: ["rent"],
    description:
      "Rent financing for Nigerian professionals. Get into your dream apartment today.",
  ...
  // Education
  {
    ...
    category: ["education"],
    description:
      "Nigerian Education Loan Fund. Government-backed student loans with low interest.",
  ...
  },
  {
    ...
    category: ["education"],
    description:
      "School fees financing for students and parents. Pay in installments.",
  ...
  },
  {
    ...
    category: ["education"],
    description:
      "Education financing made simple. Pay school fees in monthly installments.",
  ...
  },
  {
    ...
    category: ["education"],
    description:
      "Affordable digital skills programs. Flexible learning paths for software, product, and data.",
  ...
  },
  {
    ...
    category: ["education"],
    description:
      "Learning platform for students with low-cost subscription options for exam prep and core subjects.",
  ...
  // Health
  {
    ...
    category: ["health"],
    description:
      "Affordable health insurance with flexible payment plans. Quality healthcare for all.",
  ...
  // Business
  {
    ...
    category: ["business"],
    description:
      "Quick business and personal loans in minutes. No collateral required.",
  ...
  },
  {
    ...
    category: ["business"],
    description:
      "Working capital and asset financing for SMEs. Grow your business today.",
